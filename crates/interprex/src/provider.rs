pub const CODE_HOSTING_PROVIDER_ENV: &str = "INTERPREX_CODE_HOSTING_PROVIDER";
pub const TRACKER_PROVIDER_ENV: &str = "INTERPREX_TRACKER_PROVIDER";
pub const CODE_REVIEWS_PROVIDER_ENV: &str = "INTERPREX_CODE_REVIEWS_PROVIDER";
pub const JOBS_PROVIDER_ENV: &str = "INTERPREX_JOBS_PROVIDER";
pub const RELEASES_PROVIDER_ENV: &str = "INTERPREX_RELEASES_PROVIDER";
